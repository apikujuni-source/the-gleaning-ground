...
(() => {
  ...
  launch.style.cssText = 'position:fixed;right:18px;bottom:18px;z-index:2147483646;border:0;border-radius:999px;padding:12px 17px;background:#173b62;color:#fff;font:750 14px system-ui;box-shadow:0 8px 24px rgba(0,0,0,.18);cursor:pointer';
